...
\restrict dUSddHur9vwSaIy4TK0xljckdEx1bWVdigei37dw1ScJyhSa7YAatwgl2x2Y83T
...
4abdfd13-efa3-4717-a7f3-aa6b876ac0dd	14cf0b87b8358781cab1bc2998155544f545d89712084535c8b36c8441c372b2	\N	20260730000000_community_core_models	A migration failed to apply. New migrations cannot be applied before the error is recovered from. Read more about how to resolve migration issues in a production database: https://pris.ly/d/migrate-resolve\n\nMigration name: 20260730000000_community_core_models\n\nDatabase error code: 42P01\n\nDatabase error:\nERROR: relation "users" does not exist\n\nDbError { severity: "ERROR", parsed_severity: Some(Error), code: SqlState(E42P01), message: "relation \\"users\\" does not exist", detail: None, hint: None, position: None, where_: Some("SQL statement \\"ALTER TABLE users ADD COLUMN \\"privacySettings\\" JSONB\\"\\nPL/pgSQL function inline_code_block line 7 at SQL statement"), schema: None, table: None, column: None, datatype: None, constraint: None, file: Some("namespace.c"), line: Some(433), routine: Some("RangeVarGetRelidExtended") }\n\n   0: sql_schema_connector::apply_migration::apply_script\n           with migration_name="20260730000000_community_core_models"\n             at schema-engine/connectors/sql-schema-connector/src/apply_migration.rs:106\n   1: schema_core::commands::apply_migrations::Applying migration\n           with migration_name="20260730000000_community_core_models"\n             at schema-engine/core/src/commands/apply_migrations.rs:91\n   2: schema_core::state::ApplyMigrations\n             at schema-engine/core/src/state.rs:226	\N	2026-07-29 23:30:16.703469+08	0
\.
...
\unrestrict dUSddHur9vwSaIy4TK0xljckdEx1bWVdigei37dw1ScJyhSa7YAatwgl2x2Y83T
