...
-- 1. 备份相关表（安全第一）
CREATE TABLE IF NOT EXISTS "SocialTimeline_backup_20260802" AS SELECT * FROM "SocialTimeline";
CREATE TABLE IF NOT EXISTS "SocialTimelineLike_backup_20260802" AS SELECT * FROM "SocialTimelineLike";
...
SELECT id, nickname, phone, email, "isGuest", "createdAt"
FROM "User"
WHERE nickname ~* '(test|测试|临时|demo|fake|guest|debug)'
